...
namespace MPTagThat.Core.Utils
{
  public sealed class Util
  {
    ...
    public static string[] Genres { get; } =
    {
      ...
      "Rap", "Techno", "Blues", "Classical", "Country", "Hard Rock",
      "Punk Rock", "Punk", "R&B",  "Heavy Metal", "Metal",
      ...
      "Christian Rock", "Club", "Club-House",
      ...
      "Gothic", "Grunge", "Hardcore",
      "Hip-Hop", "House", "Humour",
