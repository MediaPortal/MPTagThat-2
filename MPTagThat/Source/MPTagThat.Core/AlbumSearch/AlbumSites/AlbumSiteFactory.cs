...
namespace MPTagThat.Core.AlbumSearch.AlbumSites
{
  public static class AlbumSiteFactory
  {
    ...
    /// <summary>
    /// Gets the list of Album search sites
    /// </summary>
    /// <returns>List of Album search sites</returns>
    ...
    /// <summary>
    /// Create a Album search site object by name
    /// </summary>
    /// <param name="identifier">Album site name</param>
    /// <param name="artist">Artist</param>
    /// <param name="album">Album</param>
    /// <param name="mEventStopSiteSearches">Stop event</param>
    /// <param name="timeLimit">Time limit</param>
    /// <returns>Album site object</returns>
